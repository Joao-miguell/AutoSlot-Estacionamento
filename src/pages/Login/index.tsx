// src/pages/Login/index.tsx — substitua os dois estados de tema pelo useTheme()
...
export default function Login() {
  ...
  const { temaEscuro, alternarTema } = useTheme(); // ← substitui o useState local
  const { login } = useAuth();
    ...
    <>
      ...
      <div className="login-wrapper">
        <div className="login-card" style={{ textAlign: 'center' }}>
          <img src={logoUrl} alt="AutoSlot Logo"
